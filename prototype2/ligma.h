...
namespace ligma {
    ...
    public:
        enum error_type {
            ...
            LIST_DATA_ASSIGN_NOT_LIST,
            LIST_NEXT_ASSIGN_NOT_LIST,
            VECTOR_EXTRACT_UNSUPPORTED_TYPE,
            VECTOR_EXTRACT_INVALID_INDEX,
            VECTOR_INSERT_UNSUPPORTED_TYPE,
            VECTOR_INSERT_INVALID_INDEX,
            VECTOR_INSERT_VECTOR,
            MOVE_VECTOR_DIFFERENT_SIZES,
            MOVE_STRING_INSUFFICIENT_SIZE,
            MOVE_INVALID_TYPE,
        };
